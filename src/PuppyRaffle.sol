...
contract PuppyRaffle is ERC721, Ownable {
    ...
    //@audit this function can be reentarn attck to refund a player
    // @audit there no Send value function
    ...
    /// @dev we use a hash of on-chain data to generate the random numbers //p: random number issue
